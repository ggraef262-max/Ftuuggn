        ...
        if (channel.parentId === categoryId) {
            setTimeout(async () => {
                const embed = new MessageEmbed()
                    .setTitle('**نسخ سيرفر 🔥**')
                    .setDescription(`**مرحبا بك 🔥\nتم فتح تذكرة نسخ سيرفرات. لنسخ سيرفر اضغط على زر __نسخ سيرفر 🖨️__ و لقفل التذكرة اضغط على زر __قفل التذكرة ❌__**`)
                    .setColor('#06b4d8')
                    .setImage('https://cdn.discordapp.com/icons/1332092479608197272/c4eecaa1d91dd04a57344351dd6e9702.webp');
    ...
    if (interaction.isCommand()) {
        ...
        if (commandName === 'setup') {
            ...
            try {
                ...
                const embed = new MessageEmbed()
                    .setColor('#0099ff')
                    .setTitle('تذكرة شراء نسخ سيرفرات 🖨️')
                    .setDescription(`**لشراء النسخ الرجاء قم بفتح تذكرة 
🔥 سعر النسخ : ${price} كردت**`)
                    .setImage('https://cdn.discordapp.com/icons/1332092479608197272/c4eecaa1d91dd04a57344351dd6e9702.webp')
